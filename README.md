...
graph TB
    ...
    subgraph Query
        ...
        H -->|Medium| I2[Step 3.5 Flash]
        H -->|Complex| I3[Trinity Mini]
...
"Summarize the key points"  → medium  → Step 3.5 Flash (balanced)
"Compare X and Y, analyze   → complex → Trinity Mini (powerful)
 implications for Z"
```
